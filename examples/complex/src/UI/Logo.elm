module UI.Logo exposing (rakuten)
...
rakuten : String -> Int -> Html.Html msg
rakuten color size =
    Svg.svg [ SA.height (String.fromInt size ++ "px"), SA.width (String.fromInt (size * 166 // 50) ++ "px"), SA.preserveAspectRatio "xMinYMin slice", SA.viewBox "0 0 166 50" ]
        [ Svg.path
            [ SA.fill color
